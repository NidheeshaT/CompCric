// JS from https://github.com/NidheeshaT/CompCric
let window1 = {
  top: {
...
function rand() {
  if (turn_left === 1) {
    if (userInput > 3) return Math.ceil(Math.random() * 3) + 3;
  }
...
function renderHTML() {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    else window1.top.ele[window1.top.ball[i]].innerHTML = '-';
  }
